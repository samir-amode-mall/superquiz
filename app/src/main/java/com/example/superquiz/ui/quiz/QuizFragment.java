...
public class QuizFragment extends Fragment {
    ...
    private void showAnswerValidity(Button button, Integer index){
        ...
        if (isValid) {
            ...
            binding.validityText.setText("T'es un chad ! 💪");
            button.announceForAccessibility("T'es un chad !");
        } else {
            button.setBackgroundColor(Color.parseColor("#E10102")); // Red
            binding.validityText.setText("Bozo 😢");
            button.announceForAccessibility("Bozo");
        }
